...
public class Menu {
	...
	private void atualizarEmpregado() {
		...
		if(empregado == null) {
			...
			double salario = parseDouble(showInputDialog("Novo salário"));
			empregado.setNome(nome);
			empregado.setSalario(salario);
			dao.atualizar(empregado);
			showMessageDialog(null, "Empregado atualizado com sucesso!");
		}
	}
	...
	private void cadastrarEmpregado() {
		...
		if(empregado != null) {
			showMessageDialog(null, "Empregado já cadastrado");
		} else {
